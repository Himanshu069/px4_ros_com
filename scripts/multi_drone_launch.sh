...
gnome-terminal -- bash -c "PX4_SIM_INSTANCE=1 MAV_SYS_ID=2 PX4_GZ_MODEL_POSE='0,1,0' make px4_sitl gz_x500; exec bash"
sleep 5

echo "=== Starting PX4 SITL Instance 2 ==="
gnome-terminal -- bash -c "PX4_GZ_STANDALONE=1 PX4_SIM_INSTANCE=2 MAV_SYS_ID=3 PX4_GZ_MODEL_POSE='0,2,0' ./build/px4_sitl_default/bin/px4 -i 2; exec bash"
sleep 5
